...
See [Validator Showcase](#validator-showcase) for comforting examples – or blithely continue for uncomfortable details you may regret reading.
...
If the unbridled power of beartype validators leaves you variously queasy, uneasy, and suspicious of our core worldview, beartype also supports third-party type hints like [typed NumPy arrays](#numpy-type-hints).
