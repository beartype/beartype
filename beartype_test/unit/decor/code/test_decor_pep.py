...
#die_if_fixed_list_acquired() validator raising an exception if this is *NOT*
#the case to the "beartype._util.cache.pool.utilcachepoollistfixed" submodule.
#
...
# def test_decor_pep_pass_param_kind_position_keyword() -> None:
#     '''
...
#
#
# def test_decor_pep_pass_param_kind_keyword_only() -> None:
#     '''
...
# def test_decor_pep_pass_param_tuple() -> None:
#     '''
...
#
#
# def test_decor_pep_pass_param_custom() -> None:
#     '''
#     Test type-checking for a function call successfully passed a parameter
...
#
#
# def test_decor_pep_pass_param_ref() -> None:
#     '''
#     Test type-checking for a function call successfully passed a parameter
...
# def test_decor_pep_fail_param_kind_variadic() -> None:
#     '''
...
# def test_decor_pep_fail_param_call_ref() -> None:
#     '''
...
#
#
# def test_decor_pep_fail_param_call_tuple() -> None:
#     '''
#     Test type-checking for a function call unsuccessfully passed a parameter
#     annotated with a PEP-noncompliant tuple union.
#     '''
...
# def test_decor_pep_fail_param_hint_ref_missing() -> None:
#     '''
...
#
#
# def test_decor_pep_fail_param_hint_nonpep() -> None:
#     '''
...
#
# # ....................{ TESTS ~ fail : return             }....................
# def test_decor_pep_fail_return_call() -> None:
#     '''
...
#
#
# def test_decor_pep_fail_return_hint_nonpep() -> None:
#     '''
