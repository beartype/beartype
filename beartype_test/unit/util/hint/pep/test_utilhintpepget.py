...
def test_get_hint_pep_typing_attrs_argless_to_args() -> None:
    '''
    Test the
    :func:`beartype._util.hint.pep.utilhintpepget.get_hint_pep_typing_attrs_argless_to_args`
    getter.
    '''
    ...
    for pep_hint, pep_hint_meta in PEP_HINT_TO_META.items():
        assert get_hint_pep_typing_attrs_argless_to_args(pep_hint) == (
    ...
    assert (
        get_hint_pep_typing_attrs_argless_to_args(NONPEP_HINTS[0]) is
        get_hint_pep_typing_attrs_argless_to_args(NONPEP_HINTS[1]))

# ....................{ TESTS ~ super                     }....................
def test_get_hint_pep_typing_superattrs() -> None:
    '''
    Test the
    :func:`beartype._util.hint.pep.utilhintpepget._get_hint_pep_typing_superattrs`
    getter.
    '''
    ...
    # Assert that various "typing" types are correctly detected.
    for pep_hint, pep_hint_meta in PEP_HINT_TO_META.items():
        assert _get_hint_pep_typing_superattrs(pep_hint) == (
            pep_hint_meta.superattrs)

    # Assert that various non-"typing" types are correctly detected.
    for nonpep_hint in NONPEP_HINTS:
        assert _get_hint_pep_typing_superattrs(nonpep_hint) == ()
