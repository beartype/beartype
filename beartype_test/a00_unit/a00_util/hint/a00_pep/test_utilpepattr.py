...
'''
Project-wide **PEP-compliant type hint attribute** unit tests.

This submodule unit tests the public API of the private
:mod:`beartype._util.hint.pep.utilpepattr` submodule.
'''
...
def test_import_typing_attr() -> None:
    '''
    Test the
    :func:`beartype._util.hint.pep.utilpepattr.import_typing_attr` tester.
    '''
