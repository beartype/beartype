...
"""
**Beartype object prefix utility unit tests.**

This submodule unit tests the public API of the private
:mod:`beartype._util.text.utiltextprefix` submodule.
"""
...
def test_prefix_callable() -> None:
    '''
    Test the :func:`beartype._util.text.utiltextprefix.prefix_callable`
    function.
    '''
