...
def test_is_func_wrapper() -> None:
    '''
    Test the
    :func:`beartype._util.func.utilfuncwrap.is_func_wrapper` tester.
    '''
...
def test_is_func_wrapper_isomorphic() -> None:
    '''
    Test the
    :func:`beartype._util.func.utilfuncwrap.is_func_wrapper_isomorphic` tester.
    '''

    # ....................{ IMPORTS                        }....................
    # Defer test-specific imports.
    from beartype._util.func.utilfuncwrap import is_func_wrapper_isomorphic
