...
def test_get_hint_pep484612646_typearg_packed_name() -> None:
    '''
    Test the private
    :mod:`beartype._util.hint.pep.proposal.typearg.peptypeargmain.get_hint_pep484612646_typearg_packed_name`
    getter.
    '''
...
def test_pack_hint_pep484612646_typearg_unpacked() -> None:
    '''
    Test the private
    :mod:`beartype._util.hint.pep.proposal.typearg.peptypeargmain.pack_hint_pep484612646_typearg_unpacked`
    getter.
    '''
