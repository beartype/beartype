...
def test_get_hint_pep484612646_name() -> None:
    '''
    Test the private
    :mod:`beartype._util.hint.pep.proposal.pep484612646.get_hint_pep484612646_name`
    getter.
    '''
    ...
    assert get_hint_pep484612646_name(T) == 'T'
    ...
    if IS_PYTHON_AT_LEAST_3_10:
        ...
        assert get_hint_pep484612646_name(P) == 'P'
        ...
        if IS_PYTHON_AT_LEAST_3_11:
            ...
            assert get_hint_pep484612646_name(Ts) == 'Ts'
