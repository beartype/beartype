...
'''
Test-wide :pep:`484`-compliant **forward reference type hint utility** unit
tests.
...
def test_get_hint_pep484_ref_names_absolute() -> None:
    '''
    Test
    :func:`beartype._util.hint.pep.proposal.pep484.pep484ref.get_hint_pep484_ref_names_absolute`
    getter.
    '''
