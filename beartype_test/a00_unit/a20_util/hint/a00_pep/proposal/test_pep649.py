...
:mod:`beartype._util.hint.pep.proposal.pep749.pep649749annotate` submodule.
'''
...
# ....................{ TESTS ~ getter                     }....................
def test_get_hintable_pep649749_annotations() -> None:
    '''
    Test the private
    :mod:`beartype._util.hint.pep.proposal.pep749.pep649749annotate.get_hintable_pep649749_annotations`
    getter.
    '''
    ...
    if IS_PYTHON_AT_LEAST_3_14:
        ...
        from beartype_test.a00_unit.data.pep.data_pep649 import (
            unit_test_get_hintable_pep649749_annotations)
    ...
    assert get_hintable_pep649749_annotations(too_huge) == {
    ...
    assert get_hintable_pep649749_annotations(MoreSorrow) == dict(
        like_to_this=Optional[str],
        and_such_like_woe=list['MoreSorrow'],
    )
