...
# ....................{ FIXTURES ~ equality                }....................
#FIXME: Uncomment after globally enabling the fixture approach for *ALL* such
#functions defined throughout this subpackage. *sigh*
# @fixture(scope='session')
def hints_pep_meta_pep589() -> 'List[HintPepMetadata]':
    '''
    ...
    # Set of all type hint factories declared by all importable typing modules.
    TYPING_ATTRS = get_typing_attrs('TypedDict')

    # If *NO* typing module declares this factory, the active Python interpreter
    # fails to support this PEP. In this case, return the empty tuple.
    if not TYPING_ATTRS:
        return ()
