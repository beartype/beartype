...
:attr:`beartype._check.forward.fwdcache.bear_typistry` singleton.
'''
...
def test_typistry_singleton_pass() -> None:
    ...
    from beartype._check.forward.fwdcache import bear_typistry
...
#     :func:`beartype._check.forward.fwdcache.register_typistry_type` or
#     :func:`beartype._check.forward.fwdcache.register_typistry_tuple` functions)
