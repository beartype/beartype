...
def test_api_abby_die_if_unbearable_pass() -> None:
    ...
    Note that the corresponding ``test_api_abby_die_if_unbearable_fail`` test
    resides under the :mod:`beartype_test.a60_api.abby` subpackage for
    orthogonality with other core API unit tests.
    '''
