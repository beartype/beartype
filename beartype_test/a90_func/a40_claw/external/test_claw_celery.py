...
def test_claw_celery() -> None:
    ...
    # ....................{ PASS                           }....................
    # Subject a Celery-specific data package to a beartype import hook,
    # configured by the default beartype configuration.
    beartype_package('beartype_test.a90_func.data.claw.external.celery')
    ...
    from beartype_test.a90_func.data.claw.external.celery.data_claw_celery import (
