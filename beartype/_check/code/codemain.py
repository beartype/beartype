...
def make_check_expr(
    ...
    * Raises generic non-human-readable exceptions containing the placeholder
    ...
    # below is safely memoizable back into its cache, defaulting to the
    # superficial uncacheability of the passed root hint.
    is_cacheable_check_expr = hint_sane.is_cacheable_check_expr

    # If this expression is superficially memoizable into this cache, this
    # entire root hint (and thus *ALL* child hints subscripting this root hint)
    # are hashable. Why? Because, if this root hint was unhashable, then the
    # _HintSaneMetaclass.__call__() dunder method would have already forced the
    # "hint_sane.is_cacheable_check_expr" instance variable above to false.
    # However, this variable is clearly true! Although this expression *COULD*
    # still be unmemoizable after visiting the tree of all child hints, it is
    # at least now safe to test whether this expression has already been
    # memoized into this cache. In this case...
