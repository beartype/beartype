...
class HintsMeta(FixedList):
    ...
    * This optimization implicitly "bottoms out" when the currently visited hint
    ...
    is_check_expr_cacheable : bool
        ...
        memoizable). This high-level boolean is effectively composes (combines)
        each low-level boolean
        :attr:`beartype._check.metadata.hint.hintsane.HintSane.is_check_expr_cacheable`
        across *all* child hints transitively subscripting the root hint of this
        queue. See also that instance variable for further details.
    ...
    def sanify_hint_child(
        ...
        # Semantically, this ensures that the uncacheability of even
