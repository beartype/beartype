...
class ViolationCause(object):
    ...
    **Type-checking violation cause finder** (i.e., object recursively
    ...
    hint_or_sane_childs : Optional[TupleHintOrSane]
        Either:
    ...
    if TYPE_CHECKING:
        ...
        hint_or_sane_childs: TupleHintOrSane
        hint_sign: Optional[HintSign]
        pith: Any
        pith_name: Optional[str]
        random_int: Optional[int]
    ...
    def __init__(
        ...
        hint_or_sane: Union[HintOrSane, Iota] = SENTINEL,
        ...
        hint_or_sane : HintOrSane
            ...
            :class:`.HintSane` object) generated by the sanification of
        ...
        if (
            ...
            for hint_child_insane in hint_childs_insane:
                ...
                hint_or_sane_child_sane: HintOrSane = None  # type: ignore[assignment]
