...
def make_func_checker(
    ...
    **This factory dynamically resolves all** :pep:`484`-compliant **forward
    ...
    #FIXME: How much of this factory function is in the critical section
    #requiring thread-safety? The entirety? Only the subsection pertaining to
    #the make_func_signature() call? No idea. Investigate us up, please.
    #Ideally, we'd be able to narrow this critical section for efficiency.
    #FIXME: Excise this up if this is already thread-safe without explicit
    #locking. No idea, honestly. Can't even reproduce thread-unsafety... *sigh*
    with _make_func_checker_lock:
        # ....................{ CACHE                          }....................
...
# ....................{ PRIVATE ~ globals                  }....................
#FIXME: Trivial reusable context manager. This is sufficiently useful to warrant
#defining somewhere within the *MAIN* "beartype" codebase, please. *sigh*
#FIXME: Note in the docstring that this derives from this StackOverflow answer:
#    https://stackoverflow.com/a/48908462/2809027
class ContextManagerTrivial(object):
...
#FIXME: Cleanup and docstring us up, please. *sigh*
from threading import RLock

_make_func_checker_lock = ContextManagerTrivial()
# _make_func_checker_lock = RLock()
