...
# ....................{ MAKERS                             }....................
#FIXME: Refactor in terms of the _make_func_checker() function, please.
@callable_cached
def make_func_tester(
    ...
    **Type-checking tester function factory** (i.e., low-level callable
    ...
    code_signature = make_func_signature(
        ...
        code_signature_format=FUNC_CHECKER_CODE_SIGNATURE,
        conf=conf,
    )
...
'''
**Type-checking raiser or tester function name uniquifier** (i.e., iterator
yielding the next integer incrementation starting at 0, leveraged by the
...
def _make_func_checker(
    ...
    '''
    **Type-checking raiser or tester function factory** (i.e., low-level callable
    dynamically generating a pure-Python tester function testing whether an
    arbitrary object passed to that tester satisfies the PEP-compliant type hint
    passed to this factory and either returning that result as its boolean
    return *or* raising a fatal exception or emitting a non-fatal warning if
    that result is :data:`False`).
    ...
    **This factory intentionally accepts no** ``exception_cls`` **parameter.**
    ...
    if hint_forwardrefs_class_basename:
        ...
        hint_forwardrefs_conjunction = join_delimited_conjunction(
            strs=hint_forwardrefs_class_basename, is_double_quoted=True)
    ...
    # Unqualified basename of this type-checker, uniquified by suffixing an
    # arbitrary integer guaranteed to be unique to this type-checker.
    func_checker_name = (
        f'{FUNC_CHECKER_NAME_PREFIX}{next(_func_checker_name_counter)}')
    ...
    #FIXME: So far so good. Pick up here tomorrow, please.
