...
def make_func_raiser(
    ...
    #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    hint: Hint, conf: BeartypeConf, exception_prefix: str) -> CallableRaiser:
    '''
    **Type-checking raiser function factory** (i.e., low-level callable
    ...
    arbitrary object passed to that function satisfies the type hint passed to
...
def _make_func_checker(
    ...
    **This factory intentionally accepts no** ``exception_cls`` **parameter.**
    ...
    func_checker: CallableRaiserOrTester = None  # type: ignore[assignment]
