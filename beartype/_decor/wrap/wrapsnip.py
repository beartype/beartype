...
code generated by the memoized :func:`make_func_pith_code` function.

See Also
--------
:func:`beartype._check.code.codemake.make_func_pith_code`
...
:func:`beartype._check.code.codemake.make_func_pith_code` function by:
