...
:func:`random.getrandbits` function passed to all wrapper functions generated
by the :func:`beartype.beartype` decorator  that internally require one or more
random integers).
'''
...
parameter whose default value is the beartypistry singleton passed to all
wrapper functions generated by the :func:`beartype.beartype` decorator).
'''
