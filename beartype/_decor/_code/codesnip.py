...
object defined by the external caller conditionally passed to every wrapper
function generated by the :func:`beartype.beartype` decorator explicitly
requiring that object).

The :meth:`str.format` method of this template expects these format variables:

* ``{object_id}``, this object's **unique identifier** (i.e., integer returned
  by the :func:`id` builtin when passed this object).
'''
