...
def beartype_descriptor_boundmethod(
    ...
    # Note: This now works on PyPy 3.11+! PyPy's descriptors expose __func__
    # and can be successfully wrapped. We use try-except for safety in case
    # future PyPy versions or exotic Python implementations behave differently.
    try:
...
def beartype_descriptor_decorator_builtin_property(
    ...
    # Note: This now works on PyPy 3.11+! Property descriptors expose fget/fset/fdel
    # and can be successfully wrapped. We use try-except for safety.
    try:
        # Avoid circular import dependencies.
        from beartype._decor._nontype.decornontype import beartype_func
...
def beartype_descriptor_decorator_builtin_class_or_static_method(
    ...
    # Note: This now works on PyPy 3.11+! Staticmethod/classmethod descriptors
    # expose __func__ and can be successfully wrapped. We use try-except for safety.
    try:
        # Avoid circular import dependencies.
