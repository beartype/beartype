...
# ....................{ WARNINGS                          }....................
class BeartypeWarning(Warning, metaclass=_ABCMeta):
    '''
...
class BeartypePEP563Warning(BeartypeWarning):
    '''
    **Beartype** `PEP 563`_ **warning.**

    Warnings of this category class are emitted at decoration time from the
    :func:`beartype.beartype` decorator for each annotation of the decorated
    callable that is *not* a string signifying a postponed annotation when `PEP
    563`_ is active for that callable.
