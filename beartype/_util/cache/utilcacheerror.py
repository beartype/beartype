...
# ....................{ CONSTANTS                         }....................
RERAISE_EXCEPTION_CACHED_SOURCE_STR = '$%RERAISE_EXCEPTION_CACHED_SOURCE_STR/~'
'''
...
def reraise_exception_cached(
    ...
    # Optional parameters.
    source_str: str = RERAISE_EXCEPTION_CACHED_SOURCE_STR,
) -> None:
    '''
    ...
    source_str : Optional[str]
        ...
        Defaults to :data:`RERAISE_EXCEPTION_CACHED_SOURCE_STR`.
    ...
    See Also
    ----------
    :data:`RERAISE_EXCEPTION_CACHED_SOURCE_STR`
    ...
    ----------
        ...
        ...     reraise_exception_cached, RERAISE_EXCEPTION_CACHED_SOURCE_STR)
