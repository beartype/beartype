...
# syntax governing the latter is overly verbose and largely unhelpful.
    ...
    **This highly optimized generator function should always be called in lieu
    ...
    #
    # Note: In Python 3.14+, accessing func.__call__ on a function returns a
    # method-wrapper that doesn't have __defaults__. In this case, we need to
    # get __defaults__ from the __self__ attribute (the wrapped function).
    if hasattr(func, '__defaults__'):
        args_defaults_posonly_or_flex = func.__defaults__ or ()  # type: ignore[attr-defined]
    elif hasattr(func, '__self__') and hasattr(func.__self__, '__defaults__'):
    ...
    elif hasattr(func, '__self__') and hasattr(func.__self__, '__kwdefaults__'):
