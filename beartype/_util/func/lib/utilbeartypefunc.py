...
def is_func_unbeartypeable(func: Callable) -> bool:
    ...
    return (
        ...
        is_func_pep484_no_type_checked(func) or
...
def is_func_beartyped(func: Callable) -> bool:
    ...
    :func:`beartype.beartype` decorator for a user-defined callable decorated
    by that decorator, wrapping that callable with constant-time
    type-checking).
    ...
    ----------
    bool
        ``True`` only if that callable is a beartype-generated wrapper
        function.
    '''
