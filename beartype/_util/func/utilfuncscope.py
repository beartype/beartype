...
def add_func_scope_attr(
    ...
    internally generated by this function to uniquely refer to the passed
    object and whose value is that object) to the passed scope *and* return
    that name.
    ...
    ----------
    str
        Name of the passed object in this scope as generated by this function.
