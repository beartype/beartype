...
def add_func_scope_types(
    ...
    * This tuple's hash. Note that this tuple's object ID is intentionally
    ...
    ----------
    BeartypeDecorHintPep3119Exception
        If one or more items of this type are *not* isinstanceable classes
    ...
    die_unless_hint_nonpep_tuple(hint=types, is_str_valid=False)
    ...
    if len(types) == 1:
        return add_func_scope_type(
            cls=types[0], cls_scope=types_scope, cls_label=types_label)
