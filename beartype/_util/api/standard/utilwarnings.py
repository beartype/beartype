...
# ....................{ TESTERS                            }....................
def is_func_warnings_deprecated(func: Callable) -> bool:
    '''
    ...
    # by the call to the get_codeobject_basename() getter above. In this case,
    # fallback to slower and clumsier logic. Specifically...
    else:
        return (
...
def make_func_warnings_deprecated(
    ...
    **isomorphic decorator closure** (i.e., closure created and returned by the
    standard :func:`warnings.deprecated` decorator such that that closure
