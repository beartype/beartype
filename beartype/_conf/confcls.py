...
# ....................{ TODO                               }....................
#FIXME: Refactor "violation_verbosity" into an enumeration for safety, please.
...
class BeartypeConf(object):
    ...
    **Beartype configuration** (i.e., self-caching dataclass encapsulating all
    ...
    _violation_verbosity : int
        **Violation verbosity level** (i.e., non-negative integer in the range
        ``[1, 5]`` specifying the level of verbosity in exception messages
        raised by type-checking wrappers generated by the
        :func:`beartype.beartype` decorator when either receiving a parameter
        *or* returning a value violating a type-check). Notably:

        * 1 is the least verbose.
        * 5 is the most verbose.

        See also the :meth:`__new__` method docstring.
    ...
    def __new__(
        ...
        *or* reuse that previously instantiated configuration otherwise.
        ...
        violation_verbosity : int, optional
            **Violation verbosity level** (i.e., non-negative integer in the
            range ``[1, 5]`` specifying the level of verbosity in exception
            messages raised by type-checking wrappers generated by the
            :func:`beartype.beartype` decorator when either receiving a
            parameter *or* returning a value violating a type-check). Notably:
