...
# ....................{ CALL ~ hint : pep                 }....................
#FIXME: Consider remaning this superclass and all subclasses of this
#superclass. Now that @beartype no longer distinguishes between PEP-compliant
#and PEP-noncompliant type hints when raising exceptions (because the latter
#are coerced into the former beforehand), the "Pep" in these exception names is
#superfluous and should simply be replaced by "Type". Doing so then yields
#these names:
#* "BeartypeCallHintTypeException".
#* "BeartypeCallHintTypeParamException".
#* "BeartypeCallHintTypeReturnException".
#
#Of course, we've already published these exception names. So, we'll need to
#preserve their names as deprecated aliases in "__init__": e.g.,
#    # In "beartype.roar.__init__":
...
class BeartypeCallHintPepException(BeartypeCallHintException):
    '''
    Abstract base class of all **beartyped callable type
    exceptions.**
...
# ....................{ API ~ abby                        }....................
class BeartypeCallHintTypeAbbyException(BeartypeCallHintPepException):
    '''
    **Beartype functional type exception.**

    This exception is raised at call time when passing the :func:
    `beartype.abby.die_if_unbearable` function an object violating the passed
    type hint.
    '''
