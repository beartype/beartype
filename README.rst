...
+-------------+-------------------------------------+-------------------------+------+
|             | `relative forward references`_      | *none*                  |      |
+-------------+-------------------------------------+-------------------------+------+
|             | `tuple unions <Unions of Types_>`__ | **0.1.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
| typing_     | typing.AbstractSet_                 | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Any_                         | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.AnyStr_                      | *none*                  |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.AsyncContextManager_         | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.AsyncGenerator_              | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.AsyncIterable_               | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.AsyncIterator_               | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Awaitable_                   | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.BinaryIO_                    | *none*                  |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.ByteString_                  | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Callable_                    | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.ChainMap_                    | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Collection_                  | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Container_                   | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.ContextManager_              | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Coroutine_                   | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Counter_                     | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.DefaultDict_                 | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Deque_                       | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Dict_                        | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.ForwardRef_                  | *none*                  |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.FrozenSet_                   | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Generator_                   | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Generic_                     | *none*                  |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Hashable_                    | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.IO_                          | *none*                  |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.ItemsView_                   | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Iterable_                    | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Iterator_                    | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.KeysView_                    | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.List_                        | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Mapping_                     | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.MappingView_                 | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Match_                       | *none*                  |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.MutableMapping_              | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.MutableSequence_             | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.MutableSet_                  | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.NamedTuple_                  | **0.1.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.NewType_                     | *none*                  |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.NoReturn_                    | *none*                  |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Optional_                    | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.OrderedDict_                 | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Pattern_                     | *none*                  |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Protocol_                    | *none*                  |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Reversible_                  | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Sequence_                    | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Set_                         | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Sized_                       | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.SupportsAbs_                 | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.SupportsBytes_               | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.SupportsComplex_             | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.SupportsFloat_               | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.SupportsIndex_               | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.SupportsInt_                 | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.SupportsRound_               | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Text_                        | **0.1.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.TextIO_                      | *none*                  |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Tuple_                       | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Type_                        | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.TypedDict_                   | **0.1.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.TypeVar_                     | *none*                  |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.Union_                       | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.ValuesView_                  | **0.2.0**\ —\ *current* |      |
+-------------+-------------------------------------+-------------------------+------+
|             | typing.final_                       | *none*                  |      |
+-------------+-------------------------------------+-------------------------+------+
