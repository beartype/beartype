...
.. # title. We'd prefer this title to read either:
.. # * "Inside the Bear".
.. # * "Paws-Deep". *heh*
.. # ...but all of those are rather too verbose for our TOC tree. Gah! There's
.. # something abnormal about *ONLY* this document -- but we have *NO* idea what
.. # that might be. Bisecting yielded nothing. *sigh*
