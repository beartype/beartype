...
optimistic assumption that most real-world containers are **homogeneous** (i.e.,
contain only items of the same type) rather than **heterogeneous** (i.e.,
contain items of differing types). Examples of homogeneous containers include
...
is commonly considered to be The Slowest Language Evah, because it commonly is.
